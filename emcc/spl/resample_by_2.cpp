...
void WebRtcSpl_DownsampleBy2(const int16_t* in, int16_t len,
  ...
  __REGISTER int32_t state0 = filtState[0];
  __REGISTER int32_t state1 = filtState[1];
  __REGISTER int32_t state2 = filtState[2];
  __REGISTER int32_t state3 = filtState[3];
  __REGISTER int32_t state4 = filtState[4];
  __REGISTER int32_t state5 = filtState[5];
  __REGISTER int32_t state6 = filtState[6];
  __REGISTER int32_t state7 = filtState[7];
